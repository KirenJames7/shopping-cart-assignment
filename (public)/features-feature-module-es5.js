...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-feature-module"], {
  ...
  /***/
  function srcAppFeaturesFeatureRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var featureRoutes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/features/product/product.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        ...
        /*! ./cart/cart.module */
        "./src/app/features/cart/cart.module.ts")).then(function (m) {
          return m.CartModule;
        });
      },
      path: 'cart'
    ...
    FeatureRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=features-feature-module-es5.js.map